...
pub use crml_sylo_directory_rpc_runtime_api::{self as runtime_api, SyloDirectoryApi as SyloDirectoryRuntimeApi};

/// Contracts RPC methods.
#[rpc]
pub trait SyloDirectoryApi<Balance, AccountId> {
	#[rpc(name = "sylo_directory_scan")]
